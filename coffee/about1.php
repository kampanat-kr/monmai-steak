                    ...
                    <div class="col-md-12">
                        <div class="food-item">
                            ...
                            <table style="width:100%" border="1">
                              ...
                              <?php
                              $result_group2 = $db->select("*" , "main_order","date_order ='$date_check' and status ='yes' order by id asc ");
                              $numorder = 1; $sell_all=0; $profitall_auder = 0;
                              while($row_group = $db->fetch_array($result_group2)){
                                    ...
                                    //echo "queue_order ='$queue_order' order by id desc ";
                                    //echo "<br>";
                               ?>
                              <tr>
                              ...
                              <?php $numorder = $numorder+1;
                                    $sell_all = $sell_all+$total_order;

                                    $result_group7 = $db->select("id_menu_order,number_order" , "cus_order","queue_order ='$queue_order' order by id desc ");
                                    while($row_group7 = $db->fetch_array($result_group7)){
                                          $id_menu_order = $row_group7["id_menu_order"];
                                          $number_order = $row_group7["number_order"];

                                      ?>

                                    <?php
                                    $profit = 0;
                                    $result_group6 = $db->select("id,selling_price,cost_price" , "menu_order","id ='$id_menu_order' ");
                                    while($row_group6 = $db->fetch_array($result_group6)){
                                          $profit   = $row_group6["selling_price"]-$row_group6["cost_price"];
                                          $profitall = $profit*$number_order;
                                          $profitall_auder = $profitall_auder+$profitall;
                                      ?>
                                      <tr>
                                        ...
                                        <td style="text-align: center"></td>
                                        <td style="text-align: center"></td>
                                        <td style="text-align: center"><?=$id_menu_order?>:<?=$row_group6["selling_price"];?>:<?=$row_group6["cost_price"];?></td>
                                        <td style="text-align: center"><?=$profit?>:<?=$profitall?></td>
