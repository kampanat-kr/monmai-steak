...
<body onLoad='javascript:window.print();' class="A4 Portrait">
  <section class="sheet padding-0mm" id="pdf">
    <br><br><br><br><br>
    <h1>คิวที่ No : <?=$queue_order?></h1><br>
    <h1>Monmai Coffee Hut</h1><br>
    ...
    <article>
      ...
      <?php
        ...
        <tr height ="60">
            ...
            <td width="60%"><h2><?=$menu_name[$id_menu_order]?></h2></td>
            <td width="25%"><h2><?=$number_order?>*<?=$menu_price[$id_menu_order]?></h2></td>
            <td width="15%" text-align ""><h2><?=$number_order*$menu_price[$id_menu_order]?></h2></td>
      ...
      <h4>Cass <?=$payment?> THB : Chang <?=$change_menu?> THB </h4>
      <h4>Thank You</h4>
      <h6>Password wifi : monmai2022</h6>
    </article>
  </section>
</body>
</html>
