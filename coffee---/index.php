              ...
              if($numorder != ''){
                ...
                if($num_main_order == 0){
                  ...
                  /*  if($num_main_order2 == 0){
                      $row_group1 = $db->fetch_array($result_group1);
                      $queue_order = $row_group1["queue_order"];
                      $queue_orderlast = $queue_order+1;


                      $field_arpay = " `id`,`queue_order`, `date_order`, `date_action`, `status`";
                      $data_arpay = " '','$queue_orderlast', '$date_check', '$TimeDate_Action', 'no'";
                      $result_arpay = $db->insert("main_order", "$field_arpay", "$data_arpay");

                      $field_order = " `id`,`queue_order`, `date_order`, `date_action`, `id_menu_order`, `number_order`";
                      $data_order = " '','1', '$date_check', '$TimeDate_Action', '$recipient[0]', '$numorder'";
                      $result_order = $db->insert("cus_order", "$field_order", "$data_order");
                      ...
                      if($num_main_order3 == 0){
                        $field_order = " `id`,`queue_order`, `date_order`, `date_action`, `id_menu_order`, `number_order`";
                        $data_order = " '','$queue_order', '$date_check', '$TimeDate_Action', '$recipient[0]', '$numorder'";
                        $result_order = $db->insert("cus_order", "$field_order", "$data_order");
                      }else{
                        if($numorder == 'cancel'){
                          $result_del = $db->delete("cus_order", "date_order ='$date_check' and queue_order ='$queue_order' and id_menu_order ='$recipient[0]'");
                        }else{
                          $result_up_cus_order = $db->update("cus_order", "date_action='$TimeDate_Action',id_menu_order='$recipient[0]',number_order='$numorder'", "date_order ='$date_check' and queue_order ='$queue_order' and id_menu_order ='$recipient[0]'  ");
                        }
                    ...
                    //$field_order = " `id`,`queue_order`, `date_order`, `date_action`, `id_menu_order`, `number_order`";
                    //$data_order = " '','$queue_orderlast', '$date_check', '$TimeDate_Action', '$recipient[0]', '$numorder'";
                    //$result_order = $db->insert("cus_order", "$field_order", "$data_order");
